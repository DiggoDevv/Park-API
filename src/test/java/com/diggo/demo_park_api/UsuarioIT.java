package com.diggo.demo_park_api;
...
public class UsuarioIT {
    ...
    @Test
    public void createUsuario_ComUsernameEPassordValidos_RetornarUsuarioCriadoComStatus201(){
    ...
    public void editarSenha_ComSenhasInvalidas_RetornarErrorMessageComStatus400(){
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("123456", "123456", "111222"))
                .exchange()
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("111112", "123456", "123456"))
                .exchange()
                .expectStatus().isEqualTo(400)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void ListarUsuarios_SemParametro_RetornarListaDeUsuariosComStatus200(){
